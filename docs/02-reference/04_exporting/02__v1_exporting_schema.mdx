...
title: Drafft v1 Output Schema
description: Detailed documentation on the output schema structure for Drafft v1.

---

# Output Schema

This document describes the structure of the output schema for Drafft v1, including scripts, dialogues, actors, quests, items, grids, kanban, and miscellaneous entities.
