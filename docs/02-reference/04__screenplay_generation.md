...
If the scripts are written in [Drafft Scripting Syntax](drafft-scripting-syntax) drafft can automatically detect speech lines and generate a standard screenplay.

This is useful to hand over to voice actors as the format is commonly used in the industry.

<!-- ![Screenplay](/img/scripting-02.webp) -->
