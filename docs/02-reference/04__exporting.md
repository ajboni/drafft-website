...
When an **game export** is performed, the Export Mappings kicks in and modify, if necessary, each recognized line.
...
{"speech":"What's the traffic on your side Mike?", "json":"{}"}
{"command":"CutTo(Location2)", "json":"{\"traffic\":{\"cars\":\"low\",\"trucks\":\"none\"}}"}
{"speech":"What's the traffic on your side Mike?", "json":"{}"}
{"speech":"Low traffic in this area.", "json":"{}"}
```
...
> JSON objects **WILL NOT** be shown in Director/Tagged Scripts, Screenplays or Dialogue Simulator.
