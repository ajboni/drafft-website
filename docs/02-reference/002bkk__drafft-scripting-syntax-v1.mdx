...
Commands are just functions. The benefit of using drafft syntax is that they will appear in the resulting [screenplay](./screenplay_generation).
...
Commands can also be renamed at export to a syntax more useful for the target engine. See [Export Mappings](./exporting)
...
Actor lines can also be renamed at export to a syntax more useful for the target engine. See [Export Mappings](./exporting)
