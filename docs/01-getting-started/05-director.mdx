...
{/* ![](/img/tutorial-adding-actor-expression.webp) */}
...
{/* ![Actor tagged scripts](/img/tutorial-actor-tagged-scripts.webp) */}
...
{/* ![Actor script player](/img/tutorial-dialogue-script-player.webp) */}
...
{/* ![Actor Expression in Script Player](/img/tutorial-actor-expression-in-script-player.webp) */}
