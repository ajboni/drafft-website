...
_(If you're thinking about how dialogue structure relates to branching — whether to use a tree, a script, or something in between — that's a separate question covered in [Dialogue Trees vs. Branching Scripts: Which Should You Use for Your Game?](./dialogue-trees-vs-branching-scripts))_
