...
function HomePageFAQ() {
  ...
  //   faqs.splice(0, 2);
  return (
    <div className="p-4 lg:p-12" id="faqs">
        ...
        <dl className="mt-16 divide-y divide-white/5 w-full ">
          {faqs.map((faq) => (
            <Disclosure as="div" key={faq.question} className="w-full max-w-4xl mx-auto">
              {({ open }) => (
                <>
                  <DisclosureButton className="w-full  text-base md:text-lg font-semibold text-zinc-100 py-3 text-left  bg-inherit group flex justify-between items-center">
                    {faq.question}
