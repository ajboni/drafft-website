...
import LocalDatabaseImg from "@site/static/img/privacy/local-database.png";
import SelfHostingImg from "@site/static/img/privacy/self-hosting.png";
...
# Why You'll Love It
- **Privacy by Design:** Your data is yours alone. Drafft doesn’t call home, track you, or require licenses to access your work.
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg/8 text-gray-300">
              Drafft is built with privacy in mind. By default, your data stays local and offline. If you need syncing, self-hosting gives you full control.
            </p>
          </div>
          <img
