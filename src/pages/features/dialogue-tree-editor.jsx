...
import DialogueTreeEditorImg from "@site/static/img/dialogue-tree-editor/dialogue-tree-editor-01.webp";
...
Ready to take your interactive storytelling to the next level? [Try Drafft](/download) today and start crafting better dialogues with ease!   
  ...
  return (
    <Layout title={`Features | ${siteConfig.title}`}>
      <Head>
        <meta charSet="utf-8" />
        <title>Dialogue Tree Editor | Drafft - Create and organize multiple Dialogue Trees easily</title>
        <meta
          name="description"
