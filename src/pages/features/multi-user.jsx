...
import RealTimeSyncImg from "@site/static/img/privacy/self-hosting.webp";
      ...
      <main className="bg-dark-background-darker-3 pt-8 lg:pt-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base/7 font-semibold text-primary-color-lightest">Collaborate Without Compromise</h2>
            ...
            <p className="mt-6 text-lg/8 text-gray-300">
              Drafft’s multi-user feature lets you collaborate in real time while keeping your data private and secure.
              Sync changes to your own CouchDB server—no subscriptions, no lock-in.
            </p>
          </div>
          <img
